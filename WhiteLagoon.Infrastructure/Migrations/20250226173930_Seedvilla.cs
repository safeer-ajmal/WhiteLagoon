    ...
    public partial class Seedvilla : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                table: "villas",
                columns: new[] { "Id", "Created", "Description", "ImageUrl", "Name", "Occupancy", "Price", "Sqft", "Updated" },
                values: new object[,]
                {
                    ...
                    { 3, null, "Fusce 11 tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.", "https://placehold.co/600x402", "Luxury Villa", 4, 400.0, 750, null }
                });
        }
